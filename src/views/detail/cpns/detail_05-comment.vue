<template>
  <div class="comment">
    <detail-section title="热门评论" :more-text="`查看全部${comments.totalCount}条评论`">
      <div class="infos">
        <div class="header">
          <div class="left">
            <div class="score">
              <span class="text">{{ comments.overall }}</span>
              <div class="line"></div>
            </div>

            <div class="info">
              <div class="title">{{ comments.scoreTitle }}</div>
              <div class="count">{{ comments.totalCount }}条评论</div>
              <div class="star">
                 <van-rate v-model="comments.overall" color="#ff9854" size="12" readonly allow-half />
              </div>
           </div>
          </div>
